...
class ModelPresetRunner:
    ...
    def predict(
        ...
        if model_index is not None:
            model_names = [self.avail_model_names[int(model_index)]]


        print(f"#models: {len(model_names)} Used model {model_index} for predicting {num_predictions_per_model} number.")
        outputs = {}
