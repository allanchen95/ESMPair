...
def _correct_post_merged_feats(
  ...
  if not pair_msa_sequences:
    ...
    if np_example["msa"].shape == np_example["msa_all_seq"].shape:
        ...
        np_example['bert_mask'] = msa_mask_all_seq
...
def _concatenate_paired_and_unpaired_features(
    ...
    for feature_name in features:
        ...
        elif feature_name + "_all_seq" in example:
            feat_all_seq = example[feature_name + '_all_seq']
            example[feature_name] = feat_all_seq
